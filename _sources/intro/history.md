...
timeline LR
    ...
    section Golden Age
    1940 : S.McCulloch & Pitts' Electronic Brain, Adjustable but not learnable weights
    1950s : 1950 Alan Turing Paper: Can Machine Think ? - concept of learning
          : 1956 Dartmouth Conference John McCarthy coins the term AI
          : 1957 Rosenblatt Learnable Perceptron
    Section  AI Winter [Dark Era]
		1967 : Nearest Neighbors
    1969 : M. Minsky and S. Papert XOR Problem
    section AI Winter II
    1974 : Werbos et.al Backpropagation
    1980s: Kohonen Self Organizing Map
         : Bayesian Networks
         : 1985 Hinton & Sijnowski, Boltzmann Machines
         : 1986 Rumelhart, Hinton, Wiliams Multi Layer Perceptron (Backpropagation)
         : 1986 Smolensky Restricted Boltzmann Machines
         : 1986 Jordan RNN
    1990 : Lecun, LeNet
         : 1995 Vapnik & Cortes SVM and Kernel Functions
         : 1997 Schuster & Paliwal Bidirectional RNN
         : 1997 Hochreiter & Schmidhuber LSTMS
         : 1997 IBM's Deep Blue defeats Garry Kasparaov in Chess
    section After AI Winter II
    2000 : Graphical Models
				 : 2006 Hinton Deep Belief Networks - Pretraining
         : 2006 Salakhutdinov & Hintorn Deep Boltzman Machines
         : 2009 Fei-Fei Li ImageNet Challenge
    Section Era of Deep Learning
    2012 : Krizhevsky, Sutskever, Hinton AlexNet
         : Hinton Dropout
    2014 : Goodfellow GANs
         : VGG, GoogleNet
    Section Era of LLMs
    2017 : Vaswani et. all  Attention is All you need (Transformers)
         : 2018 OpenAI GPT-1 released
         : 2022 OpenAI Chat GPT
```
